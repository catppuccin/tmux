...
function reset() {
  tmux set -gu @gruvbox_window_current_left_separator
  tmux set -gu @gruvbox_window_current_middle_separator
  tmux set -gu @gruvbox_window_current_right_separator
  tmux set -gu @gruvbox_window_status_style
}
...
reset
tmux set -g @gruvbox_window_status_style "rounded"
tmux source "${script_dir}/../gruvbox_options_tmux.conf"
tmux source "${script_dir}/../gruvbox_tmux.conf"
...
reset
tmux set -g @gruvbox_window_number_position "right"
tmux source "${script_dir}/../gruvbox_options_tmux.conf"
tmux source "${script_dir}/../gruvbox_tmux.conf"
