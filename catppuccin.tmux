...
build_window_format() {
  ...
  then
    ...
    then
      ...
      right_separator_fgbg="fg=$color,bg=$thm_bg"
    elif [ "$window_number_position" = "left" ]
    then
      left_separator_fgbg="fg=$color,bg=$thm_bg"
  ...
  local show_middle_separator="#[$middle_separator_fgbg,$style]$window_middle_separator"
  ...
  if [ "$window_number_position" = "right" ]
  then
    show_left_separator="#[$left_separator_fgbg,$style]$window_left_separator"
    show_right_separator="#[$right_separator_fgbg]$window_right_separator"

    final_window_format="$show_left_separator$show_text$show_middle_separator$show_number$show_right_separator"
  elif [ "$window_number_position" = "left" ]
  then
    show_left_separator="#[$left_separator_fgbg]$window_left_separator"
    show_right_separator="#[$right_separator_fgbg,$style]$window_right_separator"
