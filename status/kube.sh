...
show_kube() {
  ...
  text=$(get_tmux_option "@catppuccin_kube_text" "#(KUBE_TMUX_SYMBOL_ENABLE=false ${TMUX_PLUGIN_MANAGER_PATH}kube-tmux/kube.tmux 250 $context_color $namespace_color)")
