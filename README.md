...
1. Clone this repository to your desired location (e.g.
   ...
   git clone -b v2.2.0 https://github.com/catppuccin/tmux.git ~/.config/tmux/plugins/catppuccin/tmux
   ```
...
1.  Add the Catppuccin plugin:
    ...
    ```bash
    set -g @plugin 'catppuccin/tmux#v2.2.0' # See https://github.com/catppuccin/tmux/tags for additional tags
    # ...alongside
