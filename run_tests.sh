...
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/gpu_module.sh --expected "${script_dir}"/tests/gpu_module_expected.txt "$@"
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/vram_module.sh --expected "${script_dir}"/tests/vram_module_expected.txt "$@"
